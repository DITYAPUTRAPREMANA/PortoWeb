...
export class Backend implements backendInterface {
    ...
    async getAllPortfolios(): Promise<Array<Profile>> {
    ...
    async getPortfolio(arg0: Principal): Promise<Profile> {
        if (this.processError) {
            try {
    ...
    async setPortfolio(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: Array<Project>, arg7: Array<SocialMediaLink>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setPortfolio(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
